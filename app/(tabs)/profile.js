...
const profile = () => {
  ...
  const xl3 = width > 700 ? "text-3xl" : "text-[6vw]";
  const xl2 = width > 700 ? "text-2xl" : "text-[5vw]";
  const xl = width > 700 ? "text-xl" : "text-[4vw]";
  const lg = width > 700 ? "text-lg" : "text-[3vw]";
              ...
              >
                ...
                <View className="pt-2 pb-4 bg-gray-400 ">
                  <View className="flex-row justify-evenly items-center">
                    <View className="flex-col items-center">
                      <Text className={`${xl2} text-white font-semibold pt-2`}>
                  ...
                  <View className="px-4 my-4">
                    <View className="w-full h-auto border border-gray-700  rounded-xl pb-2 ">
                      ...
                      <View className="flex-row pt-2 px-2 items-center flex flex-wrap justify-evenly gap-4">
                        ...
                        >
                          <Users height={"48"} width={"48"} color={"#404040"} />
                        ...
                        >
                          <Delivered
                            ...
                            color={"#404040"}
                          />
                          <Text className="text-[12px]">Delivered Orders</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                          className="flex-col items-center"
                        ...
                        >
                          <CancelledOrders />
                          <Text className="text-[12px]">Cancelled Orders</Text>
                        </TouchableOpacity>
                      </View>
                    </View>
                  </View>
                ...
                <View className="flex-row flex-wrap justify-evenly gap-y-4 pt-3">
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => Linking.openURL("https://maxmol.com/demo1")}
                  >
                    {/* Set a fixed width */}
                    <Text className="font-semibold text-xs text-white p-1">
                      About Maxmol
